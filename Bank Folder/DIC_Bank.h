...
void phoneNumber_Validation(){
    char ph_number[20];
    int checkNumbervalid=0;
    printf("Enter your phone number");
    scanf("%s",ph_number);

    for(int i=0;ph_number[i]!='\0';i++){
         if (ph_number[i] >= '0' && ph_number[i] <= '9') {
            checkNumbervalid++;
    }else{
    ...
    if(checkNumbervalid >= 8 && checkNumbervalid <= 11 ){
        // yangon number = 01,NPT = 067 , MdY = 02,Maubin=045 ,Telenor = 097,Ooredoo=099,Mytel=096
            if(ph_number[0]=="0" || ph_number[0]=="2"|| ph_number[0]=="4"|| ph_number[0]=='7' ){
                 if( ph_number[1]=="1"){
                        //yg number
                        printf("Phone number is valid!");

                        }else if(ph_number[1]=="6" && ph_number[2]=="7"){
                            //npt number
                              printf("Phone number is valid!");
                             }else if(ph_number[1]=="2"){
                                //mdy number
                                 printf("Phone number is valid!");
                                }else if(ph_number[1]=="4" && ph_number[2]=="5"){
                                    //Maoubin number
                                     printf("Phone number is valid!");
                                    }else if(ph_number[1]=="9" && ph_number[2]=="7"){
                                        //Telenor
                                         printf("Phone number is valid!");
                                        }else if(ph_number[1]=="9" && ph_number[2]=="9"){
                                            //Ooredoo
                                             printf("Phone number is valid!");
                                             }else if(ph_number[1]=="9" && ph_number[2]=="6"){
                                                //Mytel
                                                 printf("Phone number is valid!");
                                                }else if (ph_number[1]=="5" || ph_number[1]=="6" || ph_number[1]=="7"){
                                                    //mpt
                                                  printf("Phone number is valid!");
                                                }

             }else{
                printf("You Phone number is not valid!");
                return 0;
             }
    }
